...
/** pageInterfaceInfo GET /api/interfaceInfo/page */
export async function pageInterfaceInfoUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.pageInterfaceInfoUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageInterfaceInfo>('/api/interfaceInfo/page', {
    method: 'GET',
    params: {
      ...params,
    },
